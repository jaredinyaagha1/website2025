  ...
  return (
    <main className="mx-auto px-4 py-8 md:py-12">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-5 md:gap-6">
        ...
        {/* Avatar */}
        <Card className="md:col-span-4 w-fit p-8">
          <Image
            src="/images/profile.jpg" alt="Avatar"
        ...
        <div className="md:col-span-8 grid grid-cols-1 gap-6">
          ...
          <Card className="flex items-center w-full">
            <p className="text-xl md:text-2xl leading-relaxed text-success">
        ...
        <Card className="md:col-span-6">
          <div className="flex items-center justify-between">
            ...
            <Badge className="text-xs">2023 – 2025</Badge>
          </div>
